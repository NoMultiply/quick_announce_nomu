   ...
   SEASON = {
    ...
    ENV = {
        ...
        MAPPINGS = {
            DEFAULT = {
                WORDS = {
                    SHOW_ME = '（悄悄看了下有：{SHOW_ME}）',
                    DISTANCE_FAR = '，距离我们大约有 {DIST} 步那么远哦',
                    DISTANCE_CLOSE = '，就在人家身边贴贴呢',
                    DISTANCE_FAR_WATER = '，在距离人家约 {DIST} 步的亮晶晶水面上',
                    DISTANCE_CLOSE_WATER = '，就在我身边的小水花里哦',
                ...
                ADJ = {
                    ...
                    WITHERED = '没精打采地枯萎了呀',
                    BARREN = '正饿着肚子等施肥呢',
                    SMOLDER = '在委屈地冒烟，快烧起来啦',
                    GOAT_CHARGED = '带了酥酥麻麻的静电呢',
                    GOAT_NORMAL = '是乖巧温顺的普通状态呀',
                    HOTSPRING_BOMBED = '水温咕嘟咕嘟正合适呢',
                    HOTSPRING_GLASSED = '已经变成漂亮剔透的琉璃结晶啦',
                    HOTSPRING_EMPTY = '已经干枯得连一滴小水滴都没有了呀',
                    FRUITDRAGON_RIPE = '红扑扑熟透了（好想咬一口）',
                    FRUITDRAGON_UNRIPE = '还是青涩的未成熟状态呢',
                    BIRDCAGE_EMPTY = '里面空荡荡的，没有小鸟在歌唱',
                    BIRDCAGE_FULL = '里面关着可爱的小鸟呢',
                    BIRDCAGE_SICK = '里面的小鸟生病蔫掉了（好心疼）',
                    BIRDCAGE_DEAD = '里面的小鸟去天堂睡觉了呜呜……',
                    ARCHIVE_SWITCH_FULL = '亮闪闪地被激活了哦',
                    ARCHIVE_SWITCH_EMPTY = '还在闭着眼睛睡觉没有被激活呢',
                    TOADSTOOL_EMPTY = '这里空空的没有坏蛤蟆屋',
                    TOADSTOOL_NORMAL = '里面躲着一只胖乎乎的毒菌蟾蜍',
                    ...
                    NO_BARNACLES = "光秃秃圆滚滚的",
                    SEED = "还只是个熟睡的小种子呢",
                    GROW = "还在咕噜咕噜努力生长中",
                    FULL = "已经甜滋滋地完全成熟啦",
                    OVER = "长成了超级庞大的巨型胖宝宝",
                    ROT = "已经变成烂菜叶烂木头了呀",
                    SALT_FULL = "结满了白晶晶的美味盐晶呢",
                    SALT_MED = "正在努力结晶的半路上哦",
                    SALT_LOW = "只结出了一点点小盐渣呢",
                    SALT_EMPTY = "已经被小手掏空了呀",
                    MARBLE_TALL = "完全长成高高的大理石雕塑啦",
                    MARBLE_NORMAL = "处于中等身材的状态哦",
                    MARBLE_SHORT = "才刚刚从土里探出小脑袋呢",
                    BEEBOX_FULL = "小甜蜜都快满得溢出来啦",
                    BEEBOX_SOME = "积攒了一些亮晶晶的蜂蜜哦",
                    BEEBOX_EMPTY = "连一丝丝甜头都没有呢",
                    PICKABLE_READY = "可以去开心地采摘它啦",
                    PICKABLE_EMPTY = "还在休息中慢慢蓄力长新芽呢",
                    NEST_HAS_EGG = "里面藏着一颗圆滚滚的高鸟蛋",
                    NEST_EMPTY = "只是个无依无靠的编织空巢",
                    MUSHROOMFARM_ROTTEN = "变成完全没用的朽木了呀",
                    MUSHROOMFARM_EMPTY = "里边还空着没有播种呢",
                    MUSHROOMFARM_STAGE1 = "才刚种下去不久呢",
                    MUSHROOMFARM_STAGE2 = "长势白白胖胖挺喜人的呀",
                    MUSHROOMFARM_STAGE3 = "已经长成完美的小蘑菇啦",
                    MUSHROOMFARM_STAGE4 = "多得要把小木头都挤爆啦",

                    STUMP = "变成可以当小凳子坐的矮树桩啦",
                    SAPLING = "还是个娇滴滴的小树苗呢",
                    SHORT = "才刚刚破土钻出个小绿尖",
                    NORMAL = "长得郁郁葱葱好漂亮呀",
                    TALL = "长得超级超级高，直戳云朵呢",
                    BOULDER = "已经变成大大的天然矿床啦",
